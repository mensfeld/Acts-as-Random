...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.rdoc", "Gemfile", "MIT-LICENSE", "README.md", "Rakefile", "init.rb", "lib/acts_as_random.rb", "spec/acts_as_random_spec.rb", "spec/spec_helper.rb", "Manifest", "acts_as_random.gemspec"]
